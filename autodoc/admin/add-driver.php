...
echo "<script>alert('Driver ID already exists. Please try again');</script>";
}
}
                            ...
                            <div class="body">
                                <form  method="post" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleTextInput1" name="driid" value="" required='true' maxlength="5">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  type="tel" class="form-control" id="email2" name="mobnum" value="" required="true" maxlength="10" minlength="10" pattern="[0-9]+">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
